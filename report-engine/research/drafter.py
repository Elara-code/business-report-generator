...
## 你要生成的"一节"输出格式（只输出这一节，严格 JSON，不要多余文字）
{
  ...
  "content": "简短导语（1-2 行，40-80 字，带 [N] 引用）",
...
- content 只写简短导语，禁止长段落（40-80 字即可）；
- key_points 每节 3-4 条，每条一行、≤28 字，把该节所有量化论断挂 [N] 引用；
...

{
  ...
  "sections": [
    {"title": "章节标题",
     "content": "简短导语（1-2 行，40-90 字，带 [N] 引用，禁止长段落）",
